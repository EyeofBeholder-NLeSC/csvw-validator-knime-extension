 ...
 * @author Ji Qi
 */
public class CsvwValidatorNodeDialog extends DefaultNodeSettingsPane {

	/**
	 * New dialog pane for configuring the node. The dialog created here
	 * will show up when double clicking on a node in KNIME Analytics Platform.
	 */
    protected CsvwValidatorNodeDialog() {
        super();
		...
		SettingsModelString stringSettings = CsvwValidatorNodeModel.createMetadataUrlSettingsModel();
		// Add a new String component to the dialog.
		addDialogComponent(new DialogComponentString(stringSettings, "Metadata URL", true, 10));
    }
}
