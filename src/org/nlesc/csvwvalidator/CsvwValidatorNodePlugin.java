 ...
 * @author Ji Qi
 */
public class CsvwValidatorNodePlugin extends Plugin {
    // The shared instance.
    private static CsvwValidatorNodePlugin plugin;

    /**
     * The constructor.
     */
    public CsvwValidatorNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static CsvwValidatorNodePlugin getDefault() {
        return plugin;
    }
